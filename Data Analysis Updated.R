...
#include new backlog variable for 1st semester: 1 if credited < enrolled, 0 otherwise
df$backlog_1st_semester <- ifelse(df$Curricular.units.1st.sem..credited. < df$Curricular.units.1st.sem..enrolled., 1, 0)

#include new backlog variable for 2nd semester: 1 if credited < enrolled, 0 otherwise
df$backlog_2nd_semester <- ifelse(df$Curricular.units.2nd.sem..credited. < df$Curricular.units.2nd.sem..enrolled., 1, 0)

#exclude variables: international, approved, enrolled, credited, evaluation
#without evaluation (keep grade)
df <- df[, !colnames(df) %in% c("International", "Curricular.units.1st.sem..approved.", 
                             "Curricular.units.2nd.sem..approved.", "Curricular.units.1st.sem..enrolled.", 
                             "Curricular.units.2nd.sem..enrolled.", "Curricular.units.1st.sem..credited.", 
                             "Curricular.units.2nd.sem..credited.", "Curricular.units.1st.sem..evaluations.", 
                             "Curricular.units.2nd.sem..evaluations.", "Curricular.units.1st.sem..without.evaluations.", 
